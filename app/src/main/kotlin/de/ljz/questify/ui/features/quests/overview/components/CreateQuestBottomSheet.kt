package de.ljz.questify.ui.features.quests.overview.components
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    createQuestState.value = createQuestState.value.copy(title = it)
                },
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    createQuestState.value = createQuestState.value.copy(description = it)
                },
            ...
            Row(
                ...
                Checkbox(
                    ...
                    onCheckedChange = {
                        createQuestState.value = createQuestState.value.copy(isMainQuest = it)
                    }
                )
                Text(
                    text = "Hauptquest",
